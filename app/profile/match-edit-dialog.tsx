...
export function MatchEditDialog({ match, myDisplayName, onClose, onSaved }: Props) {
  ...
  return (
    <MatchActionDialogShell busy={busy} onClose={onClose}>
      ...
      <div className="space-y-4 px-4 py-4 text-sm">
        {step === 1 && (
          <div className="space-y-3 text-muted-foreground">
            <p>
              Możesz poprawić błędne przypisanie strony albo nazwę przeciwnika — wybierasz jedną rzecz
              na edycję.
            </p>
            <p className="text-xs">
